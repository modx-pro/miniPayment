...
$package = 'minipayment'; // Class name for generation
$suffix = 'minipayment_'; // Suffix of tables.
$class_prefix = "mp"; // Prefix for classes
...
$tmp = file_get_contents($xml);
$tmp = str_replace('table="', 'table="'.$suffix, $tmp);
$tmp = preg_replace('/class=\"(.*?)\"/', 'class="'.$class_prefix.'$1"', $tmp);
